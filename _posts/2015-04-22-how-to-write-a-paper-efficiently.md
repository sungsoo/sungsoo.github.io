...
• 첫째로 아이디어를 떠오르게 해주는 툴 (엄밀히 말해 아이디어를 정리
해주는 툴)
...
이것만으로도 충분히 훌륭한 프로그램인데 검색 기능까지 매우 뛰어납니다.
검색 기능은 [<span
...
Outliner를 이용해 Introduction, Material and Methods, Results,
...
 더구나 iCloud, [Dropbox](https://www.dropbox.com)로 Sync가 되므로 언제

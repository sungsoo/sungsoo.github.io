...
본 포스트는 아파치 하둡 얀 (Apache Hadoop YARN)의 최근 논문[33]의 "Introduction" 섹션을 발췌하고, 해당 원문에 소개되는 용어 및 기술을 정리한다.

![](http://sungsoo.github.com/images/paper-yarn-architecture.png)
...
org/projects/tez.html. [3] Netty project. http://netty.io.  
...
[21] S. Loughran, D. Das, and E. Baldeschwieler. I*ntroducing Hoya – HBase on YARN*. http://hortonworks.com/blog/ introducing-hoya-hbase-on-yarn/, 2013.  

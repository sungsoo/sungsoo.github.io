...
N-스크린 협업서비스는 GIGA 네트워크, 10G 네트워크의 시대에서 콘텐츠의 생산과 소비가 점차적으로 묵시적으로 자동화되고, 관리 및 제공될 뿐만 아니라, 스마트 러닝 (smart learning), 스마트 오피스 (smart office) 등 다양한 분야에 활용될 것으로 기대한다.

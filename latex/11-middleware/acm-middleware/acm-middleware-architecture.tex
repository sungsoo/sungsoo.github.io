...
The context manager is responsible for managing contexts which are defined at $n$-screen applications. The migration manager handles the app migrations, such as, pull migration and push migration. 
...
%(Intel 2GHz, 1G RAM) 
were connected to the wireless network. 

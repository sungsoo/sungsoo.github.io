...
\alignauthor
Sung-Soo Kim\\
       \affaddr{Electronics and Telecommunications Research Insititute}\\
...
\keywords{Mobile Middleware, Collaboration Session}
%
...
However, this product supports  \textit{asymmetric collaboration} since this middleware requires a smart TV as a master in master-slave architecture to provide a collaboration service among associated apps.\\

...
HPCS 2015 학회 장소인 힐튼 호텔 (그림 \ref{fig:map})은 암스테르담 도시 중심부에서 약간 떨어진 위치에 있지만, 트램, 버스와 같은 대중 교통을 이용하면 불편없이 다닐 수 있는 위치였다.
...
\begin{figure}[htb]
        \centering
        \includegraphics[width=0.397\textwidth]{nc04.png}
        \includegraphics[width=0.397\textwidth]{nc05.png}
        \includegraphics[width=0.397\textwidth]{nc06.png}
        \includegraphics[width=0.397\textwidth]{nc07.png}
        \caption{교류한 연구자 명함}

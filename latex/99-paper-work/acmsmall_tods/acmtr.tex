...
camera-ready copy for these journals.  Then the ACM production department
...
\TeX\ typesetting system~\citeN{knuth:texbook}.  It is based
...
Scribe\/} system~\citeN{reid:scribe}.  
...
Here is an example, taken from~\citeN{7(1):137}.
...
Figure~\ref{fig:ordinary}, which is Figure~6 of \citeN{7(2):311}
\begin{figure}
\centering
\(\begin{array}{c|ccc}
     & \bot & F & T \\
...
command instead of \verb|\cite|.  For example, \citeN{7(3):359}
...
The result of \verb|\appendixhead| will look like this:

\appendixhead{todf}{0000}{1999}{
The body of this paper is to appear in
{\it ACM Transactions on Document Formatting,
(TODF)}, Vol. 8, No.1, January 1999, Pages 111--119.
}
